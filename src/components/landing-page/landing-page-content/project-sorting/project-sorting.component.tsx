...
import { sortAscending, sortDescending } from '../../../../helpers/utils';
    ...
    const sortingActions: MenuAction[] = [
        {
            ...
            text: 'A to Z',
            action: () => {
                const sortedProjects = sortAscending(projects, 'projectName', true);
        ...
        },
        {
            ...
            action: () => {
                const sortedProjects = sortDescending(projects, 'createdAt');
                setSortedProjects(sortedProjects);
            },
        },
        {
            ...
            action: () => {
                const sortedProjects = sortAscending(projects, 'createdAt');
                setSortedProjects(sortedProjects);
            },
        },
    ];
