...
export const isValidDate = (date: string, formats: OptionType): boolean =>
  dayjs(date, formats, true).isValid();

export const formatUtcToLocal = (date: string, format: string): string =>
